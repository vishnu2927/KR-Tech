  ...
  const footerCols = [
    {
      ...
      links: [
        ...
        { label: "Student Dashboard", href: "/#services" },
        { label: "Recorded Lectures & Notes", href: "/#services" },
        { label: "Doubt Support 1:1", href: "/#services" },
        { label: "Resume & Project Support", href: "/#services" },
      ],
    },
    {
      title: "Top Courses",
      links: [
        ...
        { label: "AI & Machine Learning with Python", href: "/courses" },
        { label: "Data Science & Analytics", href: "/courses" },
        { label: "React 19 & Frontend Mastery", href: "/courses" },
        { label: "DSA & Problem Solving", href: "/courses" },
      ],
    },
    {
      title: "Resources",
      links: [
        { label: "Book Free Demo", href: "/free-demo" },
        { label: "Student Dashboard Preview", href: "/#dashboard" },
        { label: "Meet 10+ Yrs Mentors", href: "/#mentors" },
        { label: "AI Mentor Kira", href: "/#ai-mentor" },
        { label: "Learner FAQ", href: "/#faq" },
      ],
    },
    {
      title: "Company",
